    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-8 md:p-12 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-4xl mx-auto">
            ...
            <PolicySection title="Information We Collect">
                <p>
                 ...
                 <ul className="list-disc list-inside pl-4">
                    <li><strong>Image Data:</strong> We collect the images you voluntarily upload for the purpose of paint color visualization. These images are sent to a third-party API (Google Gemini) for processing.</li>
                    <li><strong>Usage Data:</strong> We may automatically collect anonymous information about your device and how you use the application, such as your IP address, browser type, and operating system for analytics purposes.</li>
                </ul>
            </PolicySection>
            ...
            <PolicySection title="Use of Your Information">
                ...
                <ul className="list-disc list-inside pl-4">
                    <li>Process your uploaded images to generate paint visualizations.</li>
                    <li>Monitor and analyze usage and trends to improve your experience with the Application.</li>
                    <li>Troubleshoot problems and protect against fraudulent activity.</li>
                </ul>
            </PolicySection>
            
            <PolicySection title="Image Processing and Data Retention">
                <p>
                    The images you upload are sent to the Google Gemini API for processing. We do not store your images on our servers. According to Google's API policies, data sent to the API is not used to train their models without explicit consent. We recommend reviewing Google's API Privacy Policy for more details. We do not retain your images after the visualization is complete.
                </p>
            </PolicySection>

...
export const DisclaimerPage: React.FC = () => {
    return (
        <div className="bg-white dark:bg-gray-800 p-8 md:p-12 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-4xl mx-auto">
            <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-8 text-center">Disclaimer</h1>

            <DisclaimerSection title="For Entertainment & Estimation Purposes Only">
                <p>
                    The wallpaint visualizer is provided as a tool to help you explore and estimate how different paint colors might look in your space. The visualizations generated are for illustrative and entertainment purposes only and should not be considered a perfectly accurate representation of the final result.
                </p>
            </DisclaimerSection>
            ...
            <DisclaimerSection title="Limitation of Liability">
                 <p>
                    The developers of wallpaint shall not be held liable for any decisions made based on the use of this application, including but not limited to the purchase of paint or other materials. By using this service, you agree that you are fully responsible for your color choices and any outcomes that result.
                </p>
            </DisclaimerSection>
        </div>
    );
